(function($) { "use strict";
	...
	$(document).ready(function() {
		...
		$(".menu > ul").before("<a href=\"#\" class=\"menu-mobile\"><span style='display:none'>Mobile-nav</span></a>");
		...
		$('.menu > ul > li').hover(function() {
			if ($(window).width() > 1183) {
				$(this).children("ul").stop(true, false).addClass('active');
				//e.preventDefault();
			}	
		},function() { $(this).children("ul").stop(true, false).removeClass('active'); } );
